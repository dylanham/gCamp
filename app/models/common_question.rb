...
class CommonQuestion
  ...
  'How do I join gCamp?'  =>  'As soon as it\'s ready for the public, you\'ll see a signup link in the upper right.
      Once that\'s there, just click it and fill in the form!',
  'When will gCamp be finished?'  =>  'gCamp is a work in progress.
