...
class CommonQuestion
  ...
  def self.get_question
    ['What is gCamp?','How do I join gCamp?','When will gCamp be finished?']
  end
  ...
  def self.get_slug
    ['What is gCamp?'.downcase.gsub(" ","-"),'How do I join gCamp?'.downcase.gsub(" ","-"),
     'When will gCamp be finished?'.downcase.gsub(" ","-")]
  end
